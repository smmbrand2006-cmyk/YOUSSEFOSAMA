...
| **التشفير اليومي الدوار** | تشفير رسائل Firestore بمفتاح يتغير تلقائياً كل 24 ساعة لحماية تامة من أي تسريب أو اختراق. |
| **تسجيل الفويس والميديا** | تسجيل صوتي حي ومباشر مع مشغل فويس في الشات، وإرسال الصور من الحافظة (Ctrl+V) وعارض Lightbox. |
| **نظام الاستوري وتتبع المشاهدين** | قصص تنتهي خلال 24 ساعة (نصوص وصور) مع نافذة عرض المشاهدين ووقت المشاهدة لصاحب الحالة. |
| **تطبيق الويب التقدمي (PWA)** | تثبيت التطبيق على الشاشة الرئيسية بدون متجر، دعم العمل المستقل (Standalone)، وإشعارات خلفية حية. |
| **أذونات الهاتف الشاملة** | طلب أذونات الإشعارات، الميكروفون، والكاميرا دفعة واحدة في المتصفح لتتوارث تلقائياً داخل الـ PWA. |
...
| **البحث الفوري المباشر والخصوصية** | بحث بالاسم أو كود المستخدم (#Code) مع حماية الخصوصية ومنع كشف المستخدمين للغرباء. |
...
- **[08_ENCRYPTION_AND_NEW_FEATURES.md](file:///c:/Users/youse/OneDrive/Desktop/youssef%20app/report/08_ENCRYPTION_AND_NEW_FEATURES.md)**: نظام التشفير اليومي الدوار، المجموعات، وقائمة الإجراءات السريعة.
- **[09_STORIES_PWA_PERMISSIONS_NOTIFICATIONS.md](file:///c:/Users/youse/OneDrive/Desktop/youssef%20app/report/09_STORIES_PWA_PERMISSIONS_NOTIFICATIONS.md)**: نظام الاستوري، تتبع المشاهدات، إرسال الفويس والصور، PWA، والأذونات الشاملة وإصلاحات الخصوصية واللمس.
